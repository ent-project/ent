...
public class DevelopmentLevel2 {
    ...
    private int numHit;
    private int numRetained1a;
    private int numRetained1b;
    private int numRetainedBoth;

    public static void main(String[] args) {
        DevelopmentLevel2 dev = new DevelopmentLevel2(new Random(0xFA1AFEL));
        dev.run();
    }
    ...
    private void run() {
        ...
        log.info("");
        log.info("frequency factor: {}, max steps: {}", frequencyFactor, maxSteps);
        ...
        if (numRetainedBoth > 0) {
            log.info("retained both: {}",
                    rate(numRetainedBoth, numTotal));
        }
